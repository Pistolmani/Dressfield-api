...
public class UpdateProductRequestValidator : AbstractValidator<UpdateProductRequest>
{
    public UpdateProductRequestValidator()
    {
        ...
        RuleFor(x => x.SalePercentage).GreaterThanOrEqualTo(0).WithMessage("ფასდაკლება ვერ იქნება უარყოფითი").LessThanOrEqualTo(100).WithMessage("ფასდაკლება 100%-ზე მეტი ვერ იქნება");
